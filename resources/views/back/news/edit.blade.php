                    ...
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="meta_description" name="meta_description" class="form-control"  rows="4">{{ $news->meta_description }}</textarea>
                            </div>
                        </div>
                        <!-- /.card-body -->
                    </div>
