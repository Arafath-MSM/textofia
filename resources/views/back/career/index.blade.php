...
@section('breadcrumb')
    <div class="col-sm-6">
        ...
        <a class="btn btn-dark" href="{{ route('career.create') }}">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                <table class="table table-striped projects" id="careerTable">
                    <thead>
                        <tr>
                            <th style="width: 1%">
                                #
                        ...
                        @foreach ($careers as $post)
                            <tr>
                                ...
                                <td class="project-actions text-right">
                                    <a class="btn btn-info btn-sm" href="{{ route('career.edit', $post->id) }}">
                                        <i class="fas fa-pencil-alt">
                                        </i>
                                        Edit
                                    </a>
                                    <form id="delete-post{{ $post->id }}" class="deletion-form"
                                        action="{{ route('career.destroy', $post->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
